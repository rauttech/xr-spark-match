...
export class MockProfiles {
    private static names = ['Alice', 'Bob', 'Charlie', 'Diana', 'Eve', 'Frank', 'Grace'];
    private static roles = ['Designer', 'Developer', 'Product Manager', 'Artist', 'Musician'];
    private static tags = ['React', 'Three.js', 'UX', 'AI', 'Music', 'Hiking', 'Gaming'];
